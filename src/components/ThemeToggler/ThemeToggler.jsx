// import './ThemeToggler.styles.css';
...
//             </span>
//             <input type="checkbox" className="input" onChange={toggleTheme} checked={isDarkTheme} />
...
import { ThemeInput, ThemeLabel, ThemeMoon, ThemeSlider, ThemeSun } from './ThemeToggler.styles'
...
const ThemeToggler = ({ toggleTheme, isDarkTheme }) => {
    return (
        <ThemeLabel>
            ...
            <ThemeInput type='checkbox' onChange={toggleTheme} checked={isDarkTheme} />
            <ThemeSlider />
        </ThemeLabel>
    )
}
